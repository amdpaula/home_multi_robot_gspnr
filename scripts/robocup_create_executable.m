...
for p_index = 1:nActionPlaces
    ...
    if startsWith(place_name, "Navigating")
        action_map.(place_name).server_name = "HomeNavigateActionServer";
        action_map.(place_name).package_name = package_name;
    ...
    if startsWith(place_name, "Vacuuming")
        action_map.(place_name).server_name = "HomeVacuumActionServer";
        action_map.(place_name).package_name = package_name;
...
save("robocup_executable_real_rates.mat", "executable_homeModel");